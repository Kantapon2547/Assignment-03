...
async function main() {
    ...
    // Gets the collection (if needed for future logic).
    ...
    async function consumeViewedMessage(msg) {
        ...
        // --- REQUIREMENT FOR EXAMPLE-5 ---
        // The prompt asks to print out this specific string for both id=1 and id=2.
    ...
    app.listen(PORT, () => {
        console.log("Recommendation microservice online.");
    });
}
